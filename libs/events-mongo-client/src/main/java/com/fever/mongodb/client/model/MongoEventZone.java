...
public class MongoEventZone {
  ...
  public MongoEventZone() {
    this.id = StringUtils.EMPTY;
    this.name = StringUtils.EMPTY;
    this.capacity = 0;
    this.price = BigDecimal.ZERO;
    this.numbered = Boolean.TRUE;
  }

  public MongoEventZone(final Builder builder) {
    this.id = builder.id;
  ...
  public boolean equals(Object o) {
    ...
    MongoEventZone that = (MongoEventZone) o;
  ...
  public static final class Builder {
    ...
    public MongoEventZone build() {
      return new MongoEventZone(this);
    }
  }
}
